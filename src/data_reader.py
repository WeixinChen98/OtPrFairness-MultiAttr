...
class RecDataReader(DataReader):
    ...
    def parse_data_args(parser):
        ...
        parser.add_argument('--feature_columns', nargs='+', default=['u_gender'],
                            help='columns of features considered sensitive')
        return parser

    def __init__(self, path, dataset_name, feature_columns, sep='\t', seq_sep=','):
        ...
        self.feature_columns = [name for name in self.train_df.columns.tolist() if name not in uid_iid_label and name in feature_columns]
